...
const Nav = () => {
    return (
        <>
            <NavigationMenu className="list-none z-[500]">
                    ...
                    <NavigationMenuContent className="z-[500]">
                        <ul className="grid w-[100px] gap-2 p-4 md:w-[100px] md:grid-cols-2 lg:w-[300px]">
                            {genresArr.map((genre, idx) => (
                                <NavigationMenuLink key={idx} className="text-white text-md hover:bg-teal-600 hover:text-black transition-all rounded-md p-2" href={`/genre/${genre}`}>
                                    {genre}
                                </NavigationMenuLink>
                            ))}
                        </ul>
