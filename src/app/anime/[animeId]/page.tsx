        ...
        <section className=" lg:px-4">
            <div className="flex p-4 relative">
                ...
                <div className="ml-4 z-10 text-slate-100">
                    <h1 className="text-2xl py-1 mt-t">{info.data?.title?.romaji} ({info.data?.releaseDate})</h1>
                    ...
                    <h4 className="text-xl absolute right-3 top-0 text-teal-400"><span className="text-yellow-500 text-3xl mt-1">✩</span>{info.data?.rating}+</h4>
                </div>
